...
tile('signal', (ctx) => {
  ...
  rect(ctx, 7, 3, 2, 11, shade(BARK, -6));
  rect(ctx, 5, 13, 6, 2, shade(STONE, 4));
  // the lamp head, and the light in it
  rect(ctx, 3, 2, 6, 7, shade(RAIL_STEEL, -20));
  rect(ctx, 4, 3, 4, 4, [70, 210, 110]);
  rect(ctx, 5, 4, 2, 2, [180, 255, 200]);
});
